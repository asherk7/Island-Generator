...
public class Main {
    ...
    public static void main(String[] args) throws IOException{
        ...
        remakeMesh createNewMesh = new remakeMesh(config.islandType(), config.getShape(), config.altitude(), config.getSoilType(), config.getLakes(), config.getRivers(), config.getAquifers());
