...
public class TropicalTest {
    ...
    public void assignBiomeTest(){
        ...
        Structs.Property elev = Structs.Property.newBuilder().setKey("Elevation").setValue("200").build();
        ...
        Structs.Property elev2 = Structs.Property.newBuilder().setKey("Elevation").setValue("100").build();
        ...
        Structs.Property elev3 = Structs.Property.newBuilder().setKey("Elevation").setValue("100").build();
        ...
        tropical.assignBiome(polygonList);

        assertEquals(polygon.getProperties(2).getValue(), "rainforest");
        assertEquals(polygon1.getProperties(2).getValue(), "dryforest");
